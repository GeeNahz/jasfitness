...
const textClassification = {
  label:
    'block mb-1 md:mb-2 mx-2 md:mx-3 font-bold text-xs md:text-sm formkit-invalid:text-red-500',
  inner: `
    flex
    items-center
    max-w-md
  ...
  `,
  input:
    'w-full h-9 md:h-10 px-3 border-none text-sm md:text-base text-gray-700 placeholder-gray-400',
...
const buttonClassification = {
  wrapper: 'mb-1',
  input:
    'w-full h-9 md:h-10 px-3 md:px-4 py-1 md:py-2 border-none font-semibold text-sm md:text-base text-white disabled:opacity-75 bg-yellow-600 enabled:hover:bg-yellow-500 transition duration-75 ease-out shadow-xl enabled:hover:shadow-yellow-100 rounded'
}
...
export default {
  ...
  color: {
    ...
    input:
      'w-12 md:w-16 h-7 md:h-8 appearance-none cursor-pointer border border-gray-300 rounded-md mb-1 md:mb-2 p-1'
  },
