<template>
  <div id="body" class="flex flex-row items-center w-full h-full">
    <div
      class="w-80 h-full flex flex-col items-center py-4 float-left border-r-2 border-gray-300"
    >
      <!-- logo -->
      <div
        class="logo h-10 w-10 rounded bg-yellow-500 my-20 flex items-center justify-center text-white font-semibold"
      >
        JF
      </div>
      <!-- outer side bar -->
      <div class="h-full burger-menu relative">
        <ul class="space-y-16 text-lg">
          <li>
            <router-link :to="{ name: 'DashboardHome' }" class="flex gap-4">
        ...
        <router-link
          :to="{ name: 'LoginPage' }"
          class="absolute bottom-10 flex items-center space-x-4"
          ><div class="icon">
    ...
    <div class="flex gap-4 h-full w-full p-4">
      <div class="main-body bg-white h-full w-4/5 rounded">
        <!-- welcome text -->
        <div
        ...
        >
          <p class="absolute -top-4 left-4 bg-white px-2 py-1">
            Attendance Summary
          </p>
          <div
            class="flex w-full justify-between capitalize text-center px-10 py-4"
          >
            <div class="item">
              <p>total in 2022</p>
              <p class="text-3xl font-semibold">195</p>
              <p>days at the gym</p>
            </div>
            <div class="item">
              <p>total in september</p>
              <p class="text-3xl font-semibold">13</p>
              <p>days at the gym</p>
            </div>
            <div class="item">
              <p>average</p>
              <p class="text-3xl font-semibold">95%</p>
              <p>attendance</p>
            </div>
          </div>
        </div>
        ...
        <div class="mx-10">
          <!-- divider -->
          <div class="relative border mb-4 mx-auto w-11/12">
            <p
              class="absolute -top-3 left-[50%] -translate-x-[50%] bg-white rounded-full px-3"
            >
              My Fitness Record
            </p>
          </div>
      ...
      <div class="bg-zinc-900 w-1/5 rounded relative py-16 px-3 text-white">
        <!-- top -->
        <div>
          <p class="block text-center text-lg font-semibold">Members</p>
